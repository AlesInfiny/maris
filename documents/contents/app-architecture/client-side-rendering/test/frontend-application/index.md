...
| 単体テスト ( UT0 ) | 単体テスト       | 自動       | モジュール単位でUI・ロジック・コンポーネントを検証                               |
| 単体テスト ( UT0 ) | 機能内結合テスト | 自動       | 機能内の UI・ロジック・コンポーネント間の結合により機能の実現を検証          |
| 単体テスト ( UT0 ) | ユースケーステスト | 自動       | 機能間の結合によりユースケースの実現を検証 |
| 結合テスト ( ITa ) | 自動 E2E テスト       | 自動 | フロントエンド・バックエンドアプリケーション間の結合を検証   |
| 結合テスト ( ITa ) | E2E テスト       | 手動 | フロントエンド・バックエンドアプリケーション間の結合を検証   |
