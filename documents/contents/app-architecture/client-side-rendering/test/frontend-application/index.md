...
| ------------ | :------------------------------- | ---------- | :------------------------------------- |
| UT0          | 静的解析                         | 自動       | リンター、フォーマッター、型チェッカー |
| UT0          | 単体テスト                       | 自動       | Vitest                                 |
| UT0          | 機能内結合テスト                 | 自動       | Vitest Browser Mode                    |
| UT0          | 機能間結合テスト                 | 自動       | Vitest Browser Mode                    |
| ITa          | クライアント・サーバー結合テスト | 自動・手動 | Playwright                             |
