...
できるかぎり画面に留まらせる方針　非同期エラーによって画面がリフレッシュされちゃうと困る
なにかエラーに飛ばす条件　401など
...
axios では、業務エラーとシステムエラーは例外として扱われます。　システムエラーは500以降？
...
API通信で発生する例外は業務エラー？システムエラー？
500番などはシステムエラーとして認識し、window.onerrorなどに渡す
