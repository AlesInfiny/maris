...
本プライバシーポリシーは、本サイト (`https://maris.alesinfiny.org/`) において提供するサービスに適用されます。

## 2. 個人情報の取得について {#collection-of-personal-information}
<!-- textlint-disable @textlint-ja/no-synonyms -->
本サイトでは、お問い合わせフォームや会員登録機能などを設けておらず、利用者から氏名、住所、電話番号、メールアドレスなどの個人情報を直接取得することはありません。
...
Cookie は、利用者のブラウザーに保存される小さなデータファイルであり、本サイトの利用状況を分析する目的で使用されます。

利用者は、ブラウザーの設定により Cookie の受け入れを拒否または削除できます。
<!-- textlint-disable @textlint-ja/no-synonyms -->
## 5. 第三者への情報提供 {#information-to-third-parties}
<!-- textlint-enable @textlint-ja/no-synonyms -->
当社は、法令に基づく場合を除き、取得した情報を第三者へ提供することはありません。

## 6. プライバシーポリシーの変更 {#policy-changes}

当社は、法令の改正その他必要に応じて、本プライバシーポリシーを変更することがあります。
