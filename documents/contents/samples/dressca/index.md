...
![カタログアイテム注文の画面遷移図](../../images/samples/screen-flow-order-dark.png#only-dark){ width="600" loading=lazy }
...
![カタログアイテム編集の画面遷移図](../../images/samples/screen-flow-edit-item-dark.png#only-dark){ width="600" loading=lazy }
