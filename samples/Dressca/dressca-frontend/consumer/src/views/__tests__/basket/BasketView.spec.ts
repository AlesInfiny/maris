...
function createGetBasketItemsResponse(): GetBasketItemsResponse {
  return {
    ...
    basketItems: [
      {
        catalogItemId: '01971a00-0000-7000-8000-000000000001',
        quantity: 1,
        unitPrice: 1980,
        catalogItem: {
          id: '01971a00-0000-7000-8000-000000000001',
      ...
      {
        catalogItemId: '01971a00-0000-7000-8000-000000000002',
        quantity: 2,
        unitPrice: 4800,
        catalogItem: {
          id: '01971a00-0000-7000-8000-000000000002',
          name: '裏起毛 スキニーデニム',
