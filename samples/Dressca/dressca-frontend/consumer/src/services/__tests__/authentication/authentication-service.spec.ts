...
describe('authenticationService_signOut', () => {
  ...
  describe('ログアウト後に store が初期化される', () => {
    it('全ストアの state が初期値にリセットされる', () => {
      ...
      basketStore.addedItemId = '01971a00-0000-7000-8000-000000000042'
      basketStore.deletedItemIds = [
        '01971a00-0000-7000-8000-000000000001',
        '01971a00-0000-7000-8000-000000000002',
        '01971a00-0000-7000-8000-000000000003',
      ]
      catalogStore.categories = [{ id: '', name: 'カテゴリ1' }]
      catalogStore.brands = [{ id: '', name: 'ブランド1' }]
