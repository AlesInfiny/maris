...
internal class AnnouncementHistoryConfiguration : IEntityTypeConfiguration<AnnouncementHistory>
{
    ...
    public void Configure(EntityTypeBuilder<AnnouncementHistory> builder)
    {
        ...
        builder.HasData(
            ...
            new AnnouncementHistory { Id = Guid.Parse("0193ae97-b800-7003-8001-000000000014"), AnnouncementId = Guid.Parse("0193ae97-b800-7001-8001-000000000014"), ChangedBy = "system", CreatedAt = new DateTimeOffset(2025, 1, 20, 0, 0, 0, TimeSpan.Zero), OperationType = OperationType.Create, Category = "一般", PostDateTime = new DateTimeOffset(2025, 1, 20, 0, 0, 0, TimeSpan.Zero), ExpireDateTime = new DateTimeOffset(2026, 1, 1, 20, 0, 0, TimeSpan.Zero), DisplayPriority = DisplayPriority.Medium, },
            new AnnouncementHistory { Id = Guid.Parse("0193ae97-b800-7003-8001-000000000015"), AnnouncementId = Guid.Parse("0193ae97-b800-7001-8001-000000000015"), ChangedBy = "system", CreatedAt = new DateTimeOffset(2025, 1, 21, 0, 0, 0, TimeSpan.Zero), OperationType = OperationType.Create, Category = "一般", PostDateTime = new DateTimeOffset(2025, 1, 21, 0, 0, 0, TimeSpan.Zero), ExpireDateTime = new DateTimeOffset(2026, 1, 1, 21, 0, 0, TimeSpan.Zero), DisplayPriority = DisplayPriority.Low, },
            new AnnouncementHistory { Id = Guid.Parse("0193ae97-b800-7003-8001-000000000016"), AnnouncementId = Guid.Parse("0193ae97-b800-7001-8001-000000000017"), ChangedBy = "system", CreatedAt = new DateTimeOffset(2025, 1, 21, 0, 0, 0, TimeSpan.Zero), OperationType = OperationType.Create, Category = "テスト", PostDateTime = new DateTimeOffset(2030, 1, 21, 0, 0, 0, TimeSpan.Zero), ExpireDateTime = new DateTimeOffset(2100, 1, 1, 21, 0, 0, TimeSpan.Zero), DisplayPriority = DisplayPriority.Low, },
            new AnnouncementHistory { Id = Guid.Parse("0193ae97-b800-7003-8001-000000000017"), AnnouncementId = Guid.Parse("0193ae97-b800-7001-8001-000000000018"), ChangedBy = "system", CreatedAt = new DateTimeOffset(2025, 1, 21, 0, 0, 0, TimeSpan.Zero), OperationType = OperationType.Create, Category = "テスト", PostDateTime = new DateTimeOffset(2030, 1, 21, 0, 0, 0, TimeSpan.Zero), ExpireDateTime = new DateTimeOffset(2100, 1, 1, 21, 0, 0, TimeSpan.Zero), DisplayPriority = DisplayPriority.Low, },
