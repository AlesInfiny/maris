...
internal class AnnouncementContentHistoryConfiguration : IEntityTypeConfiguration<AnnouncementContentHistory>
{
    ...
    public void Configure(EntityTypeBuilder<AnnouncementContentHistory> builder)
    {
        ...
        builder.HasData(
            ...
            new AnnouncementContentHistory { Id = Guid.Parse("44444444-4444-4444-4444-444444444423"), AnnouncementHistoryId = Guid.Parse("33333333-4444-3333-3333-333333333301"), LanguageCode = "es", Title = "スペイン語 español", Message = "内容", LinkedUrl = "https://maris.alesinfiny.org/", },
